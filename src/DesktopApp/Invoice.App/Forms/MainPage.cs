...
namespace Invoice.App.Forms
{
    public partial class MainPage : Form
    {
        ...
        {
            CreateOrder form2 = new CreateOrder(_serviceProvider);
        ...
        {
            ProductList form2 = new ProductList(_serviceProvider);
            form2.WindowState = FormWindowState.Maximized;
            form2.Show();
        }
        /*
        ...
        */
        ...
        {
            MyStore form2 = new MyStore(_serviceProvider);
            form2.Show();
        }

        private void StoreListBtn_Click(object sender, EventArgs e)
        {
            StoreList form2 = new StoreList(_serviceProvider);
            form2.WindowState = FormWindowState.Maximized;
            form2.Show();
        }
     ...
     /*   private void CreatItemBtn_Click(object sender, EventArgs e)
        ...
        */
        ...
        {
            CreateCatagory form2 = new CreateCatagory(_serviceProvider);
            form2.Show();
        }
    }
}
